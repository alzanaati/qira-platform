    ...
    <div className='flex flex-col h-full bg-[#07070e] overflow-hidden'>
      <div className='flex items-center gap-2.5 px-3 py-2.5 bg-black/50 border-b border-white/[0.06] flex-shrink-0'>
        ...
        <div className='flex-1 min-w-0'>
          <div className='flex items-center gap-2'><span className='flex items-center gap-1 bg-red-500 text-white text-[10px] font-bold px-2 py-0.5 rounded-md'><span className='w-1.5 h-1.5 bg-white rounded-full animate-pulse-live'/>مباشر</span><span className='text-sm font-bold truncate'>{stream.title}</span></div>
      ...
      <div className='flex flex-1 overflow-hidden'>
        <div className='flex-1 flex flex-col overflow-hidden'>
          <div className='flex-1 bg-[#0d0d1a] flex items-center justify-center text-[#333] text-sm'>
            <div className='text-center'><div className='text-5xl mb-2'>📡</div><div>منطقة المحتوى · اربط LiveKit للبث الحقيقي</div></div>
          </div>
